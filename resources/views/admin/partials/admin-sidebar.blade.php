     ...
     @if(Auth::check())
      ...
      @endif
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('products.create')}}"><i class="fa fa-circle-o"></i> Add Product</a></li>
            <li><a href="{{route('products.index')}}"><i class="fa fa-circle-o"></i> Products Management</a></li>
          </ul>
        </li>
        <!-- Categories -->
        <li class="treeview">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Brands</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('brands.create')}}"><i class="fa fa-circle-o"></i> Add Brand</a></li>
            <li><a href="{{route('brands.index')}}"><i class="fa fa-circle-o"></i> Brands Management</a></li>
          </ul>
        </li>
        <!-- Suppliers -->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('suppliers.create')}}"><i class="fa fa-circle-o"></i> Add Supplier</a></li>
            <li><a href="{{route('suppliers.index')}}"><i class="fa fa-circle-o"></i> Suppliers Management</a></li>
          </ul>
        </li>
